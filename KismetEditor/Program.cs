...
namespace Solicen.KismetEditor
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            CLI.Console.WriteLine($"[DarkGray][CLI] [White]KismetEditor {vers} - by Solicen (Denis Solicen)");
            CLI.Console.WriteLine("[DarkGray][URL] [White]https://github.com/SolicenTEAM/KismetEditor");
            CLI.Console.Separator(64);
            CLI.Console.WriteLine("[Yellow]Toss a coin: [Blue]https://dalink.to/solicen");
            CLI.Console.Separator(64);
